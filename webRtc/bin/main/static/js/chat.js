...
socket.addEventListener("message", async(data) =>{ 
	...
	switch(data.type){
		case "join":
			...
			console.log("sent the offer")
			console.log(offer)
			socket.send(makeMessage("offer", {offer , roomName}))
			break;
		case "offer":
			...
			myPeerConnection.setRemoteDescription(data.payload.offer);
			const answer = await myPeerConnection.createAnswer();
			myPeerConnection.setLocalDescription(answer);
			socket.send(makeMessage("answer", {answer , roomName}))
			console.log("sent the answer")
			break;
		case "answer":
			console.log("received the answer")
			console.log(data);
			myPeerConnection.setRemoteDescription(data.payload.answer);
			break;
		case "ice":
			console.log("received ice candidate")
			console.log(data.payload.candidate)
			ice = data.payload.candidate;
...
function handleIce(data){
	...
	socket.send(makeMessage("ice", { candidate, roomName}));
}
